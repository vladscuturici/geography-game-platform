...
export interface ConditionRecord {
  ...
  /** Path to the symbol image. Placeholder until per-category PNGs exist. */
  symbol: string;
}
...
export const CONDITION_RECORDS: ConditionRecord[] = [
  ...
  { id: 'subregion-central-asia', label: 'From Central Asia', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-central-europe', label: 'From Central Europe', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-eastern-africa', label: 'From Eastern Africa', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-eastern-asia', label: 'From Eastern Asia', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-eastern-europe', label: 'From Eastern Europe', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-melanesia', label: 'From Melanesia', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-micronesia', label: 'From Micronesia', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-middle-africa', label: 'From Middle Africa', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-north-america', label: 'From North America', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-northern-africa', label: 'From Northern Africa', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-northern-america', label: 'From Northern America', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-northern-europe', label: 'From Northern Europe', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-polynesia', label: 'From Polynesia', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-south-america', label: 'From South America', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-south-eastern-asia', label: 'From South-Eastern Asia', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-southern-africa', label: 'From Southern Africa', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-southern-asia', label: 'From Southern Asia', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-southern-europe', label: 'From Southern Europe', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-western-africa', label: 'From Western Africa', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-western-asia', label: 'From Western Asia', category: ConditionCategory.Subregion, symbol: './reg.png' },
  { id: 'subregion-western-europe', label: 'From Western Europe', category: ConditionCategory.Subregion, symbol: './reg.png' },
  ...
  // borders
  { id: 'borders-russia', label: 'Borders Russian Federation', category: ConditionCategory.Borders, symbol: './rus.png' },
  ...
  // language
  { id: 'speaks-arabic', label: 'Speaks Arabic', category: ConditionCategory.Language, symbol: './ara.png' },
  { id: 'speaks-english', label: 'Speaks English', category: ConditionCategory.Language, symbol: './eng.png' },
  { id: 'speaks-french', label: 'Speaks French', category: ConditionCategory.Language, symbol: './francais.png' },
  { id: 'speaks-german', label: 'Speaks German', category: ConditionCategory.Language, symbol: './deu.png' },
  { id: 'speaks-portuguese', label: 'Speaks Portuguese', category: ConditionCategory.Language, symbol: './por.png' },
  { id: 'speaks-russian', label: 'Speaks Russian', category: ConditionCategory.Language, symbol: './russian.png' },
  { id: 'speaks-spanish', label: 'Speaks Spanish', category: ConditionCategory.Language, symbol: './esp.png' },
